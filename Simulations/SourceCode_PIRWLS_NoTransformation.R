...
No_Cohort_Smoothing_Symmetry= function(m, n, Y, E, p, start.values, lambda1, lambda2, max.iter=10, 	max.iter.phi=20, dist="Poisson", phi.input=1.00, 	get.V.matrix=FALSE, fix.phi=FALSE){
