...
# Simulation of NegBin data with kink
...
for (k in 1:sim.N){
  set.seed(seed.in + k)
	...
	### grid search
	# grid.l1 = grid.l2 = c(10, 50, 100, 150, 200)
	...
	# z = t(matrix(grid.search$out[,5],4,4))
	# range(z)
	...
	## Analsis with transformed data set - NegBin1 distribution  50 - 750
	fit0.NegBin1.method2 = Cohort_Smoothing_No_Symmetry(m=m, n=n, Y=Y, E=E, input.Pen=pen_method2_no_kink, 
	                                                    lambda1=50, lambda2=750, max.iter=25, max.iter.phi=25, dist="Neg.Bin1")
	fit1.NegBin1.method2 = Cohort_Smoothing_Symmetry(m=m, n=n, Y=Y, E=E, p=p, input.Pen=pen_method2_no_kink, 
	                                                 lambda1=50, lambda2=750, start.values=fit0.NegBin1.method2$eta.start, phi.input=fit0.NegBin1.method2$phi, 
	                                                 max.iter=100, max.iter.phi=100, fix.phi=FALSE, get.V.matrix=TRUE, dist="Neg.Bin1")

	## Analsis with transformed penalty - NegBin1 distribution  50 - 750
	...
	fit1.NegBin1.method3 = Cohort_Smoothing_Symmetry(m=m, n=n, Y=Y, E=E, p=p, input.Pen=pen_method3_no_kink,
	                                                 lambda1=50, lambda2=750, start.values=fit0.NegBin1.method3$eta.start, phi.input=fit0.NegBin1.method3$phi,
	                                                 max.iter=100, max.iter.phi=100, fix.phi=FALSE, get.V.matrix=TRUE, dist="Neg.Bin1")

		## Analsis with transformed data set - NegBin1 distribution - with kink  50 - 750
	fit1.NegBin1.method4 = Cohort_Smoothing_Symmetry(m=m, n=n, Y=Y, E=E, p=p, input.Pen=pen_method2_kink, 
	                                                 lambda1=50, lambda2=750, start.values=fit0.NegBin1.method2$eta.start, phi.input=fit0.NegBin1.method2$phi,
	                                                 max.iter=100, max.iter.phi=100, fix.phi=FALSE, get.V.matrix=TRUE, dist="Neg.Bin1")
	
	## Analsis with transformed penalty - NegBin1 distribution  - with kink  50 - 750
...
save(matrix.conv.ind1, matrix.conv.ind2, matrix.edf, matrix.ll, matrix.aic, matrix.bic, matrix.phi,
     ...
     file="newoutput/NegBin_kink.RData")
...
load("newoutput/NegBin_kink.RData")


t4.matrix.conv.ind1 = matrix.conv.ind1 
t4.matrix.conv.ind2 = matrix.conv.ind2 
t4.matrix.edf = matrix.edf
t4.matrix.ll = matrix.ll 
t4.matrix.aic = matrix.aic 
t4.matrix.bic = matrix.bic
t4.matrix.phi = matrix.phi
t4.estimated.ETAmatrix1 = estimated.ETAmatrix1 
t4.estimated.ETAmatrix2 = estimated.ETAmatrix2 
t4.estimated.ETAmatrix3 = estimated.ETAmatrix3 
t4.estimated.ETAmatrix4 = estimated.ETAmatrix4 
t4.estimated.ETAmatrix5 = estimated.ETAmatrix5
t4.estimated.COVmatrix1 = estimated.COVmatrix1 
t4.estimated.COVmatrix2 = estimated.COVmatrix2 
t4.estimated.COVmatrix3 = estimated.COVmatrix3 
t4.estimated.COVmatrix4 = estimated.COVmatrix4
t4.estimated.COVmatrix5 = estimated.COVmatrix5


matrix.conv.ind1 = rbind(t1.matrix.conv.ind1, t2.matrix.conv.ind1, t3.matrix.conv.ind1, t4.matrix.conv.ind1)
matrix.conv.ind2 = rbind(t1.matrix.conv.ind2, t2.matrix.conv.ind2, t3.matrix.conv.ind2, t4.matrix.conv.ind2)
matrix.edf = rbind(t1.matrix.edf, t2.matrix.edf, t3.matrix.edf, t4.matrix.edf)
matrix.ll  = rbind(t1.matrix.ll, t2.matrix.ll, t3.matrix.ll, t4.matrix.ll)
matrix.aic = rbind(t1.matrix.aic, t2.matrix.aic, t3.matrix.aic, t4.matrix.aic)
matrix.bic = rbind(t1.matrix.bic, t2.matrix.bic, t3.matrix.bic, t4.matrix.bic)
matrix.phi = rbind(t1.matrix.phi, t2.matrix.phi, t3.matrix.phi, t4.matrix.phi)
estimated.ETAmatrix1 = c(t1.estimated.ETAmatrix1, t2.estimated.ETAmatrix1, t3.estimated.ETAmatrix1, t4.estimated.ETAmatrix1)
estimated.ETAmatrix2 = c(t1.estimated.ETAmatrix2, t2.estimated.ETAmatrix2, t3.estimated.ETAmatrix2, t4.estimated.ETAmatrix2)
estimated.ETAmatrix3 = c(t1.estimated.ETAmatrix3, t2.estimated.ETAmatrix3, t3.estimated.ETAmatrix3, t4.estimated.ETAmatrix3)
estimated.ETAmatrix4 = c(t1.estimated.ETAmatrix4, t2.estimated.ETAmatrix4, t3.estimated.ETAmatrix4, t4.estimated.ETAmatrix4)
estimated.ETAmatrix5 = c(t1.estimated.ETAmatrix5, t2.estimated.ETAmatrix5, t3.estimated.ETAmatrix5, t4.estimated.ETAmatrix5)
estimated.COVmatrix1 = c(t1.estimated.COVmatrix1, t2.estimated.COVmatrix1, t3.estimated.COVmatrix1, t4.estimated.COVmatrix1)
estimated.COVmatrix2 = c(t1.estimated.COVmatrix2, t2.estimated.COVmatrix2, t3.estimated.COVmatrix2, t4.estimated.COVmatrix2)
estimated.COVmatrix3 = c(t1.estimated.COVmatrix3, t2.estimated.COVmatrix3, t3.estimated.COVmatrix3, t4.estimated.COVmatrix3)
estimated.COVmatrix4 = c(t1.estimated.COVmatrix4, t2.estimated.COVmatrix4, t3.estimated.COVmatrix4, t4.estimated.COVmatrix4)
estimated.COVmatrix5 = c(t1.estimated.COVmatrix5, t2.estimated.COVmatrix5, t3.estimated.COVmatrix5, t4.estimated.COVmatrix5)
...
image.plot(x1-1,x2-1,bias.ETA1,zlim=c(-0.60,0.60),col=topo.colors(20), main="Model M0 without kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.ETA2,zlim=c(-0.60,0.60),col=topo.colors(20), main="Model M1 without kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.ETA3,zlim=c(-0.60,0.60),col=topo.colors(20), main="Model M2 without kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.ETA4,zlim=c(-0.60,0.60),col=topo.colors(20), main="Model M1 with kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.ETA5,zlim=c(-0.60,0.60),col=topo.colors(20), main="Model M2 with kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
...
image.plot(x1-1,x2-1,GAMMA.TRUE,zlim=c(0.0,1.30),col=topo.colors(20), main="True surface", 
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.GAMMA1,zlim=c(-0.10,0.10),col=topo.colors(20), main="Model M0 without kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.GAMMA2,zlim=c(-0.10,0.10),col=topo.colors(20), main="Model M1 without kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.GAMMA3,zlim=c(-0.10,0.10),col=topo.colors(20), main="Model M2 without kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.GAMMA4,zlim=c(-0.10,0.101),col=topo.colors(20), main="Model M1 with kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
image.plot(x1-1,x2-1,bias.GAMMA5,zlim=c(-0.10,0.10),col=topo.colors(20), main="Model M2 with kink",
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
...
image.plot(x1-1,x2-1,mse.ETA5,zlim=c(0.00,0.31),col=topo.colors(20), 
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
...
range(mse.GAMMA5)
par(mar=c(5.1,6.1,2.1,1.5))
image.plot(x1-1, x2-1, mse.GAMMA5, zlim=c(0.00,0.032), col=topo.colors(20), 
           xlab="Age of the respondent", ylab="Age of the contact", cex.lab=1.6, cex.axis=1.6)
