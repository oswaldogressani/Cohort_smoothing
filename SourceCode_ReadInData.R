...
Load_Social_Contact_Data = function(){
	...
	# Read in demography: 
	# population size from 0 to 80 years of age (the last category does not include 
	# 81 and over)
	dir="Data/Demography/"
	...
	tilde.e=hist(partdata$participant_age,
	             breaks=seq(0,100,1)-0.5,plot=F)$counts[1:77]
